                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <a href="#" class="nav-link {{Request::routeIs('product-name.index') || Request::routeIs('product-name.create') ? 'active' : '' }}">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('product-name.index')}}" class="nav-link {{Request::routeIs('product-name.index ') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Product Names</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                <a href="{{route('product-name.create')}}" class="nav-link {{Request::routeIs('product-name.create') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <!-- Start DropDown Menu -->
                        <li class="nav-item">
                            <a href="#" class="nav-link {{Request::routeIs('quantity.index') || Request::routeIs('quantity.create') ? 'active' : '' }}">
                                <i class="fas fa-tags nav-icon"></i>
                                <p>
                                    Quantity
                                    <i class="right fas fa-angle-left"></i>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('quantity.index')}}" class="nav-link {{ Request::routeIs('quantity.index') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Quantities</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{route('quantity.create')}}" class="nav-link {{ Request::routeIs('quantity.create') ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add Quantity</p>
                                    </a>
                                </li>
