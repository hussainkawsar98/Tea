...
@section('title', 'All Sub Category | Develop by Muktar Hussain')
          ...
          <div class="card mb-4">
              <div class="card-header">
                <div class="d-flex justify-content-between">
                    <h3 class="card-title pt-2">Sub Category List</h3>
                ...
                <table class="table table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$subcategory->Productname->count()}}</td>
                      <td class="d-flex">
                        <a href="{{route('subcategory.edit', $subcategory->id)}}" class="btn btn-sm btn-primary mr-1"><i class="fas fa-edit"></i></a>
                    ...
                    <tr>
                      <td colspan="4">
                        <h5 class="text-center text-danger">No Sub Categories Found.</h5>
                      </td>
                    </tr>
                    @endif
                  </tbody>
